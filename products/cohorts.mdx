...
<CodeGroup>
```ts Web (npm)
import Replay from "@replayfyapp/browser";

const replay = Replay.init({
...
```html Web (CDN)
<script src="https://us.replayfy.app/sdk/replay.js"></script>
<script>
  Replay.init({
  ...
  Replay.identify("user_8f21", { email: "ada@acme.com", plan: "Pro" });
  Replay.track("payment_success", { amount: 4900, currency: "usd" });
</script>
```
</CodeGroup>
